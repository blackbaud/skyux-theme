...
const skyScssPath = path.join(
  __dirname,
  '../projects/theme/src/styles/sky.scss'
);
...
function validateSkyuxIconVersionMatch() {
  ...
  const packageJson = fs.readJsonSync(
    path.resolve(__dirname, '../projects/theme/package.json')
  );
...
function copyScss() {
  ...
  renderScss(skyScssPath, path.resolve(__dirname, '../dist/theme/css/sky.css'));

  renderScss(
    path.resolve(
      __dirname,
      '../projects/theme/src/styles/themes/modern/styles.scss'
    ),
...
function copyDesignTokens() {
  ...
  fs.copySync(
    path.resolve(
      __dirname,
      '../projects/theme/src/styles/_variables-public.scss'
    ),
...
function copyCompatMixins() {
  ...
  fs.copySync(
    path.join(
      process.cwd(),
      './projects/theme/src/styles/themes/modern/_compat'
    ),
